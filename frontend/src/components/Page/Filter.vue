...
<script>
  ...
  export default {
    ...
    computed:{
      curFileList(){
        // return this.$store.getters.curFileList.filter(file =>
        //   this.getType(file.type_of_node)==this.nodeType
        // )
    ...
    methods:{
      ...
      getType(type_of_node){
        if (type_of_node == 'JPG' ||
                ...
                type_of_node == 'png' ||
                type_of_node == 'GIF' ||
                type_of_node == 'gif')return 'img'
        else if(type_of_node == 'mp3' ||
                type_of_node == 'wav' ||
                type_of_node == 'wma' ||
                type_of_node == 'rm'  ||
                type_of_node == 'm4a') return 'music'
        else if(type_of_node == 'flv' ||
                type_of_node == 'avi' ||
                type_of_node == 'mov' ||
                type_of_node == 'mp4' ||
                type_of_node == 'wmv') return 'video'
        else if(type_of_node=='dir')return 'dir'
        else return 'doc'
      }
    }
  }
