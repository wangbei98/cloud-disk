  ...
  <div>
    <div class="toolBar">
      ...
      <div >
        ...
        <el-button-group>
          <el-button :type="nameType" icon="el-icon-sort-down" @click='handleNameSort'></el-button>
          <el-button :type="timeType" icon="el-icon-time" @click='handleTimeSort'></el-button>
        </el-button-group>
        <el-button-group>
        ...
        <el-button icon="el-icon-plus" @click="dialogNewFolderFormVisible = true">新建文件夹</el-button>
        <el-button icon="el-icon-upload" @click="dialogUploadFormVisible = true">上传文件</el-button>
      </div>
    </div>
    ...
    <el-dialog
      width="30%"
      title="新建文件夹"
      :visible.sync="dialogNewFolderFormVisible">
...
<script>
  ...
  export default {
    ...
    computed:{
      curFileList(){
        console.log('computed curFileList')
        if(this.sortType == 'name'){
          console.log('sortType == name')
          return this.$store.getters.curFileList.sort(function(file1,file2){
            if(file1.filename > file2.filename)return 1
            else return -1
          })
        }else if(this.sortType == 'time'){
          console.log('sortType == time')
          return this.$store.getters.curFileList.sort(function(file1,file2){
            return file1.upload_time - file2.upload_time
          })
        }
      },
      pathItems(){
